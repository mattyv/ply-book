...
`cargo ply --help` and `cargo ply explain` cite section marks such as `§6`, `§8`, and `The-Ply-Spec.md §5.4c`. Those refer to sections of Ply's own specification, not this book. See [`The-Ply-Spec.md`](https://github.com/mattyv/ply/blob/bb50f1dd1411e8910a29fa70ccd5b65a8830d2e0/The-Ply-Spec.md) at the pinned revision if you want that reasoning in full.
