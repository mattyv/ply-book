...
cargo install --git https://github.com/mattyv/ply \
  --rev 1b2705b797f3cdedde40a52a40719cbb9cc00174 --locked ply-cli
cargo ply --version
cargo ply --help
```
...
`cargo ply --help` and `cargo ply explain` cite section marks such as `§6`, `§8`, and `The-Ply-Spec.md §5.4c`. Those refer to sections of Ply's own specification, not this book. See [`The-Ply-Spec.md`](https://github.com/mattyv/ply/blob/1b2705b797f3cdedde40a52a40719cbb9cc00174/The-Ply-Spec.md) at the pinned revision if you want that reasoning in full.
