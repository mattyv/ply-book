...
A named set of restrictions a component adopts, such as bans on particular source constructs. It is not Cargo's development or release build profile. Read the pinned [profile reference](https://github.com/mattyv/ply/blob/1b2705b797f3cdedde40a52a40719cbb9cc00174/docs/SCHEMA.md#profiles) and the command's report to distinguish declared policy from checked findings.
